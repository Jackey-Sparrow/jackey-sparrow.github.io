...
!function(o){"use strict";o.module("ionic.extension").directive("ionGoogleMap",["$ionicModal",function(o){return{restrict:"A",scope:{},link:function(n,e){e.bind("click",function(){o.fromTemplateUrl("platform/templates/ion-google-map.html",{scope:n,animation:"animated bounceInRight",hideDelay:1020}).then(function(o){n.modal=o,n.modal.show()})}),n.ionMap={hide:function(){n.modal.hide(),n.modal.remove()},latlng:{lat:43.07493,lng:-89.381388}},n.$on("$destroy",function(){n.modal&&n.modal.remove(),e.unbind("click")})}}}]),o.module("ionic.extension").controller("ionGoogleMapController",["$scope","$ionicLoading","$compile","$timeout",function(o,n,e,t){function i(){o.latlng=o.ionMap.latlng;var n=new google.maps.LatLng(o.latlng.lat,o.latlng.lng),t={center:n,zoom:16,mapTypeId:google.maps.MapTypeId.ROADMAP},i=new google.maps.Map(document.getElementById("map"),t),a='<div><a ng-click="clickTest()">Click me!</a></div>',l=e(a)(o),c=new google.maps.InfoWindow({content:l[0]}),d=new google.maps.Marker({position:n,map:i,title:"Uluru (Ayers Rock)"});google.maps.event.addListener(d,"click",function(){c.open(i,d)}),o.map=i}t(function(){"complete"===document.readyState?i():google.maps.event.addDomListener(window,"load",i)}),o.centerOnMe=function(){o.map&&(o.loading=n.show({content:"Getting current location...",showBackdrop:!1}),navigator.geolocation.getCurrentPosition(function(n){o.map.setCenter(new google.maps.LatLng(n.coords.latitude,n.coords.longitude)),o.loading.hide()},function(n){alert("Unable to get location: "+n.message),o.loading.hide()}))},o.clickTest=function(){alert("Example of infowindow with ng-click")},o.back=function(){o.ionMap.hide()}}])}(angular);
